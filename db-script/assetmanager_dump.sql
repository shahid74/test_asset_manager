...
--
-- Host: localhost    Database: assetmanager
-- ------------------------------------------------------
...
CREATE TABLE `test_account` (
  ...
  `encrypted_security_answer` varchar(256) DEFAULT NULL,
...
INSERT INTO `test_account` VALUES (1,'user','shahid','44##2@444444444444444444','what is your pets name','FFGGG#####GGGGGGGGGee4333455','first'),(2,'user','shahid','44444444444444444444####','what is your pets name','FFGGGGGGGGGG####GGee4333455','second');
...
-- Dump completed on 2015-08-18  2:30:34
